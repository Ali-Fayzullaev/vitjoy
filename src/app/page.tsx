    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="bg-[#60C20E] hover:bg-[#4ea30c]"
            >
        ...
        >
          <motion.div variants={itemVariants} className="flex justify-center">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-[#60C20E] rounded-full opacity-20 animate-pulse scale-150"></div>
            </div>
          </motion.div>
          
          <motion.h1 variants={itemVariants} className="text-4xl md:text-6xl font-bold tracking-tight">
            Добро пожаловать в{' '}
            <span className="text-gradient">VITJOY</span>
          </motion.h1>
          
          <motion.p variants={itemVariants} className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Премиальные витамины и пищевые добавки для вашего здоровья 
            и благополучия. Качество, которому можно доверять.
          </motion.p>
        </motion.section>
        ...
        <motion.section 
          ...
          animate="visible"
        >
          <motion.div variants={itemVariants} className="text-center p-8 rounded-2xl bg-card border hover-lift">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Инновационные формулы с быстрым и заметным результатом для вашего здоровья
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="text-center p-8 rounded-2xl bg-card border hover-lift">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Профессиональный подход к поддержанию вашего благополучия и здоровья
            </p>
          </motion.div>
        </motion.section>
